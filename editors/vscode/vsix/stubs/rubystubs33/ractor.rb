...
class Ractor
  ...
  def self.select(*ractors, move: _, yield_value: _) end
  ...
  def self.yield(msg, move: false) end
  ...
  def initialize(*args, name: nil) end
  ...
  class MovedObject < BasicObject
    ...
    alias equal? method_missing
    alias instance_eval method_missing
    alias instance_exec method_missing
  end
  ...
  class Selector
    ...
    def wait(receive: false, yield_value: true, move: false) end
  end
