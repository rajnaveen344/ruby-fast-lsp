...
class RubyVM
  ...
  module AbstractSyntaxTree
    ...
    def self.parse(string, keep_script_lines: RubyVM.keep_script_lines, error_tolerant: false, keep_tokens: false) end
    ...
    #
    #  See ::parse for explanation of keyword argument meaning and usage.
    def self.parse_file(pathname, keep_script_lines: RubyVM.keep_script_lines, error_tolerant: false, keep_tokens: false) end
  ...
  class InstructionSequence
    ...
    def self.compile_file_prism(*args) end
    ...
    def self.compile_prism(*args) end
  ...
  module YJIT
    ...
    def self.format_number(pad, number) end

    # Format a number along with a percentage over a total value
    def self.format_number_pct(pad, number, total) end

    # Print stats and dump exit locations
    def self.print_and_dump_stats; end
