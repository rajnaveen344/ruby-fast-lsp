...
class Thread
  ...
  def self.each_caller_location(*args) end
  ...
  #
  # See also ::ignore_deadlock.
  def self.ignore_deadlock=(boolean) end
  ...
  # There is also an instance level method to set this for a specific thread,
  # see #report_on_exception=.
  def self.report_on_exception=(boolean) end
  ...
  # There is also a class level method to set this for all new threads, see
  # ::report_on_exception=.
  def report_on_exception=(boolean) end
  ...
  class SizedQueue
    ...
    def push(object, non_block = false, timeout: nil) end
    alias enq push
    alias << push
  end
end
