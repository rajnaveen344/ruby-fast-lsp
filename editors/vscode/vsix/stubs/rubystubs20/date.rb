...
class Date
  ...
  def self._httpdate(string) end

  # Returns a hash of parsed elements.
  def self._iso8601(string) end

  # Returns a hash of parsed elements.
  def self._jisx0301(string) end
  ...
  # Returns a hash of parsed elements.
  def self._rfc2822(string) end

  # Returns a hash of parsed elements.
  def self._rfc3339(string) end

  # Returns a hash of parsed elements.
  def self._rfc822(string) end
  ...
  # Returns a hash of parsed elements.
  def self._xmlschema(string) end
  ...
  #
  # See also jd.
  def self.civil(p1 = v1, p2 = v2, p3 = v3, p4 = v4) end
  ...
  def self.today(*several_variants) end
