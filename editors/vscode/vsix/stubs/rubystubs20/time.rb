...
class Time
  ...
  def self.at(*several_variants) end
  ...
  def self.gm(*several_variants) end

  # Same as Time::gm, but interprets the values in the
  # local time zone.
  #
  #    Time.local(2000,"jan",1,20,15,1)   #=> 2000-01-01 20:15:01 -0600
  def self.local(*several_variants) end

  # Same as Time::gm, but interprets the values in the
  # local time zone.
  #
  #    Time.local(2000,"jan",1,20,15,1)   #=> 2000-01-01 20:15:01 -0600
  def self.mktime(*several_variants) end
  ...
  #    Time.utc(2000,"jan",1,20,15,1)  #=> 2000-01-01 20:15:01 UTC
  #    Time.gm(2000,"jan",1,20,15,1)   #=> 2000-01-01 20:15:01 UTC
  def self.utc(*several_variants) end
  ...
  #    j.utc?                          #=> false
  #    t == j                          #=> true
  def getlocal(*several_variants) end
  ...
  #    t.utc?                                  #=> false
  def localtime(*several_variants) end
