...
module Readline
  ...
  #
  # Raises NotImplementedError if the using readline library does not support.
  def self.basic_quote_characters=(string) end
  ...
  #
  # Raises NotImplementedError if the using readline library does not support.
  def self.basic_word_break_characters=(string) end
  ...
  #
  # Raises NotImplementedError if the using readline library does not support.
  def self.completer_quote_characters=(string) end
  ...
  #
  # Raises NotImplementedError if the using readline library does not support.
  def self.completer_word_break_characters=(string) end
  ...
  #
  # Raises NotImplementedError if the using readline library does not support.
  def self.delete_text(*several_variants) end
  ...
  #
  # Raises NotImplementedError if the using readline library does not support.
  def self.filename_quote_characters=(string) end
  ...
  #
  # Raises NotImplementedError if the using readline library does not support.
  def self.insert_text(string) end
  ...
  #
  # Raises NotImplementedError if the using readline library does not support.
  def self.pre_input_hook=(proc) end
  ...
  #
  # Raises ArgumentError if +proc+ does not respond to the call method.
  def self.quoting_detection_proc=(proc) end
  ...
  #     print "-> ", buf, "\n"
  #   end
  def self.readline(prompt = '', add_hist = false) end
  ...
  #
  # Raises NotImplementedError if the using readline library does not support.
  def self.special_prefixes=(string) end
  ...
  #     print "-> ", buf, "\n"
  #   end
  def readline(prompt = '', add_hist = false) end
end
