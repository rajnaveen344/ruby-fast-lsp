...
module Enumerable
  ...
  def find_index(*several_variants) end
  ...
  #    end
  #    longest                                        #=> "sheep"
  def inject(*several_variants) end
  alias reduce inject
  ...
  #    #   ***
  #    #   *
  def max_by(*several_variants) end
  ...
  def min_by(*several_variants) end
  ...
  #   #=>["foo\n", "barbaz\n", "\n", "qux\n"]
  def slice_after(*several_variants) end
  ...
  #     }
  #   }
  def slice_before(*several_variants) end
