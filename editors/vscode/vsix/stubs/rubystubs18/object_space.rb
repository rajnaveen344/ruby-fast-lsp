...
module ObjectSpace
  ...
  # deprecated
  def self.add_finalizer(p1) end

  # deprecated
  def self.call_finalizer(p1) end
  ...
  # deprecated
  def self.finalizers; end

  # Initiates garbage collection, unless manually disabled.
  def self.garbage_collect; end

  # deprecated
  def self.remove_finalizer(p1) end
  ...
  # deprecated
  def add_finalizer(p1) end

  # deprecated
  def call_finalizer(p1) end
