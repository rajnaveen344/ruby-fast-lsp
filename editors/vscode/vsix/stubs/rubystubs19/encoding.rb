...
class Encoding
  ...
  def self.find(*several_variants) end
  ...
  class Converter < Data
    AFTER_OUTPUT = _
    CRLF_NEWLINE_DECORATOR = _
    CR_NEWLINE_DECORATOR = _
    INVALID_MASK = _
    INVALID_REPLACE = _
    PARTIAL_INPUT = _
    UNDEF_HEX_CHARREF = _
    UNDEF_MASK = _
    UNDEF_REPLACE = _
    UNIVERSAL_NEWLINE_DECORATOR = _
    XML_ATTR_CONTENT_DECORATOR = _
    XML_ATTR_QUOTE_DECORATOR = _
    XML_TEXT_DECORATOR = _
    ...
    def self.asciicompat_encoding(*several_variants) end
    ...
    def self.search_convpath(*several_variants) end
    ...
    def primitive_convert(*several_variants) end
