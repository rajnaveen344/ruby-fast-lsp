...
module OpenSSL
  ...
  class BN
    ...
    def mod_add(p1, p2) end

    # bn.mod_exp(bn1, bn2) -> aBN
    def mod_exp(p1, p2) end

    # bn.mod_inverse(bn2) => aBN
    def mod_inverse(p1) end

    # bn.mod_mul(bn1, bn2) -> aBN
    def mod_mul(p1, p2) end

    # bn.mod_sqr(bn2) => aBN
    def mod_sqr(p1) end

    # bn.mod_sub(bn1, bn2) -> aBN
    def mod_sub(p1, p2) end
  ...
  class Engine
    ...
    # returned.
    def self.load(enginename = nil) end
  ...
  module ExtConfig
    ...
    OPENSSL_NO_SOCK = _
    TLS_DH_anon_WITH_AES_256_GCM_SHA384 = _
  end
  ...
  module OCSP
    ...
    class BasicResponse
      ...
      # +store+ and +flags+.
      def verify(*several_variants) end
    end
    ...
    class CertificateId
      ...
      def initialize(subject, issuer, digest = nil) end
