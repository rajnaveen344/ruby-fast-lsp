...
class Module
  ...
  def self.constants(*several_variants) end
  ...
  def class_variable_defined?(*several_variants) end
  ...
  def class_variable_get(*several_variants) end
  ...
  #    Fred.new.foo                             #=> 101
  def class_variable_set(*several_variants) end
  ...
  def const_defined?(*several_variants) end
  ...
  def const_get(*several_variants) end
  ...
  def const_set(*several_variants) end
  ...
  def method_defined?(*several_variants) end
  ...
  def module_eval(string = nil, filename = nil, lineno = nil) end
  ...
  #      end
  #    end
  def private_class_method(*several_variants) end
  ...
  def private_method_defined?(*several_variants) end
  ...
  #    C.method_defined? "method2"             #=> true
  def protected_method_defined?(*several_variants) end

  # Makes a list of existing class methods public.
  #
  # String arguments are converted to symbols.
  def public_class_method(*several_variants) end
  ...
  #    C.method_defined? "method2"          #=> true
  def public_method_defined?(*several_variants) end
  ...
  def attr_accessor(*several_variants) end

  # Creates instance variables and corresponding methods that return the
  # value of each instance variable. Equivalent to calling
  # ``<code>attr</code><i>:name</i>'' on each name in turn.
  # String arguments are converted to symbols.
  def attr_reader(*several_variants) end

  # Creates an accessor method to allow assignment to the attribute
  # <i>symbol</i><code>.id2name</code>.
  # String arguments are converted to symbols.
  def attr_writer(*several_variants) end
  ...
  #    Charge it!
  #    #<B:0x401b39e8>
  def define_method(*several_variants) end
  ...
  alias method_added included
  alias method_removed included
  alias method_undefined included
  ...
  def private(*several_variants) end

  # With no arguments, sets the default visibility for subsequently
  # defined methods to protected. With arguments, sets the named methods
  # to have protected visibility.
  # String arguments are converted to symbols.
  def protected(*several_variants) end

  # With no arguments, sets the default visibility for subsequently
  # defined methods to public. With arguments, sets the named methods to
  # have public visibility.
  # String arguments are converted to symbols.
  def public(*several_variants) end

  # Refine <i>klass</i> in the receiver.
  #
  # Returns an overlaid module.
  def refine(klass) end
  ...
  # String arguments are converted to symbols.
  def remove_method(*several_variants) end
  ...
  def undef_method(*several_variants) end
