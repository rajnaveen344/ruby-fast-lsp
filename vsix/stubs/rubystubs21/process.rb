...
module Process
  ...
  #   #=> 1.0e-09
  def self.clock_getres(p1, p2 = v2) end
  ...
  def self.clock_gettime(p1, p2 = v2) end
  ...
  def self.daemon(*several_variants) end
  ...
  def self.getsid(*several_variants) end
  ...
  # So the result can be interpreted differently across systems.
  # Time.now is recommended over CLOCK_REALTIME.
  def clock_gettime(p1, p2 = v2) end
  ...
  # standard output and standard error to /dev/null.
  # Return zero on success, or raise one of Errno::*.
  def daemon(*several_variants) end
  ...
  #    Process.getsid(0)               #=> 27422
  #    Process.getsid(Process.pid())   #=> 27422
  def getsid(*several_variants) end
