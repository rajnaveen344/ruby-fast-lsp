...
class Rational < Numeric
  ...
  def floor(*several_variants) end
  ...
  def rationalize(*several_variants) end
  ...
  def round(*several_variants) end
  ...
  def truncate(*several_variants) end
end
