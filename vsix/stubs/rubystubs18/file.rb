...
class File < IO
  ...
  def self.basename(file_name, *suffix) end
  ...
  def self.expand_path(file_name, *dir_string) end
  ...
  def self.lchown(owner_int, group_int, file_name, *args) end
  ...
  #    File.umask(0006)   #=> 18
  #    File.umask         #=> 6
  def self.umask(*several_variants) end
