...
class StringScanner
  ...
  def initialize(string, dup = false) end
  ...
  def scan_full(pattern, return_string_p, advance_pointer_p) end
  ...
  def search_full(pattern, return_string_p, advance_pointer_p) end
