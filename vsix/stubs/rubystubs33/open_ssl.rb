...
module OpenSSL
  ...
  module PKey
    ...
    def self.new_raw_private_key(algo, string) end

    # See the OpenSSL documentation for EVP_PKEY_new_raw_public_key()
    def self.new_raw_public_key(algo, string) end
    ...
    # See the OpenSSL documentation for EVP_PKEY_new_raw_private_key()
    def new_raw_private_key(algo, string) end

    # See the OpenSSL documentation for EVP_PKEY_new_raw_public_key()
    def new_raw_public_key(algo, string) end
  ...
  class Provider
    ...
    class ProviderError < OpenSSLError
    end
  end
  ...
  module SSL
    ...
    class SSLSocket
      ...
      def export_keying_material(label, length) end
