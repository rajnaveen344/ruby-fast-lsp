...
class BasicSocket < IO
  ...
  #   p s1.do_not_reverse_lookup                 #=> true
  def self.do_not_reverse_lookup=(bool) end
  ...
  def do_not_reverse_lookup=(bool) end
  ...
  #     end
  #   }
  def recvmsg(maxmesglen = nil, flags = 0, maxcontrollen = nil, opts = {}) end
  ...
  def recvmsg_nonblock(maxdatalen = nil, flags = 0, maxcontrollen = nil, opts = {}) end
  ...
  def sendmsg(mesg, flags = 0, dest_sockaddr = nil, *controls) end
  ...
  # and it doesn't retry the system call.
  def sendmsg_nonblock(mesg, flags = 0, dest_sockaddr = nil, *controls) end
  ...
  def setsockopt(*several_variants) end
