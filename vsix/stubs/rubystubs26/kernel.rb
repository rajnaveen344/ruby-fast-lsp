...
module Kernel
  ...
  def self.BigDecimal(initial, digits = 0, exception: true) end
  ...
  def self.Float(arg, exception: true) end
  ...
  def self.Rational(*several_variants) end
  ...
  #    d.remove   #=> 99
  #    d.var      #=> nil
  def remove_instance_variable(*several_variants) end
  ...
  #
  # See also String#to_r.
  def Rational(*several_variants) end
