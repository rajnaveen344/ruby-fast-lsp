...
#ifndef EXTENSION_IREP
#error "EXTENSION_IREP must name the mrbc-generated bytecode symbol"
#endif
...
extern const uint8_t EXTENSION_IREP[];
...
static void ensure_state(void) {
  ...
  mrb_load_irep(state, EXTENSION_IREP);
  if (state->exc) {
    abort();
  }
}
...
int32_t abi_version(void) { return 1; }
