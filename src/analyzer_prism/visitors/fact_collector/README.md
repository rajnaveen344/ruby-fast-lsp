...
This module contains the core Ruby Prism traversal for Ruby Fast LSP.

## Overview

The collector walks Ruby code once and emits analysis facts: symbols, methods,
types, graph edges, reference candidates, diagnostic candidates, extension
patches, and variable scopes. The analysis engine owns storage and resolution.
...
3. Creating facts for each definition (class, method, variable, etc.)
4. Recording reference candidates for engine resolution
