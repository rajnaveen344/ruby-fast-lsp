...
mod tests {
    ...
    fn test_config_deserialization() {
        ...
        assert_eq!(config.stubs_path, "/custom/stubs");
    ...
    fn test_config_partial_deserialization() {
        ...
        assert_eq!(config.stubs_path, ""); // Should use default
    ...
    fn test_ruby_version_parsing() {
        let test_cases = vec![
            ("3.0", Some(MinorVersion::new(3, 0))),
            ("3.1", Some(MinorVersion::new(3, 1))),
            ("2.7", Some(MinorVersion::new(2, 7))),
            ("1.9", Some(MinorVersion::new(1, 9))),
            ("auto", None),
            ("invalid", None),
            ("3", None), // Missing minor version
            ("3.0.1", Some(MinorVersion::new(3, 0))), // Should ignore patch version
        ];
