...
impl FactCollector {
    pub(in crate::indexer::fact_collector) fn process_constant_read_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_constant_read_node_exit(
        &mut self,
        _node: &ConstantReadNode,
    ) {
    }

    pub(in crate::indexer::fact_collector) fn text_range_from_prism_location(
        &self,
    ...
    pub(in crate::indexer::fact_collector) fn text_range_from_source_range(
        &self,
