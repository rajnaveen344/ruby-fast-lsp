...
impl FactCollector {
    pub(in crate::indexer::fact_collector) fn process_local_variable_read_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_read_node_exit(
        &mut self,
        _node: &LocalVariableReadNode,
    ) {
    }
}
