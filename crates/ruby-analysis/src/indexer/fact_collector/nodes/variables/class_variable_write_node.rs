...
impl FactCollector {
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_write_node_exit(
        &mut self,
        node: &ClassVariableWriteNode,
    ) {
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_target_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_target_node_exit(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_or_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_or_write_node_exit(
        &mut self,
        node: &ClassVariableOrWriteNode,
    ) {
        self.bind_class_variable_write(
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_and_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_and_write_node_exit(
        &mut self,
        node: &ClassVariableAndWriteNode,
    ) {
        self.bind_class_variable_write(
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_operator_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_operator_write_node_exit(
        &mut self,
        node: &ClassVariableOperatorWriteNode,
    ) {
        self.bind_class_variable_write(
