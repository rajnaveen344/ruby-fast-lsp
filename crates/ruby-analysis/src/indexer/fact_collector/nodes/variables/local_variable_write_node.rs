...
impl FactCollector {
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_write_node_exit(
        &mut self,
        node: &LocalVariableWriteNode,
    ) {
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_target_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_target_node_exit(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_or_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_or_write_node_exit(
        &mut self,
        node: &LocalVariableOrWriteNode,
    ) {
        self.bind_local_variable_write(
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_and_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_and_write_node_exit(
        &mut self,
        node: &LocalVariableAndWriteNode,
    ) {
        self.bind_local_variable_write(
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_operator_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_local_variable_operator_write_node_exit(
        &mut self,
        node: &LocalVariableOperatorWriteNode,
    ) {
        self.bind_local_variable_write(
