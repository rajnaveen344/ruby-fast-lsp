...
impl FactCollector {
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_read_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_class_variable_read_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_global_variable_read_node_entry(
        &mut self,
