...
impl FactCollector {
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_write_node_exit(
        &mut self,
        node: &InstanceVariableWriteNode,
    ) {
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_target_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_target_node_exit(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_or_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_or_write_node_exit(
        &mut self,
        node: &InstanceVariableOrWriteNode,
    ) {
        self.bind_instance_variable_write(
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_and_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_and_write_node_exit(
        &mut self,
        node: &InstanceVariableAndWriteNode,
    ) {
        self.bind_instance_variable_write(
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_operator_write_node_entry(
        &mut self,
    ...
    pub(in crate::indexer::fact_collector) fn process_instance_variable_operator_write_node_exit(
        &mut self,
        node: &InstanceVariableOperatorWriteNode,
    ) {
        self.bind_instance_variable_write(
