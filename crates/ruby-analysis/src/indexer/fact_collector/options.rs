...
pub(super) struct CollectionOptions {
    pub(super) record_local_read_unknown_reasons: bool,
    pub(super) resolve_analysis_method_returns: bool,
    pub(super) infer_expression_receivers: bool,
    pub(super) infer_call_outcomes: bool,
