...
#[derive(Default)]
pub(super) struct ExpressionEvidence {
    pub(super) max_live_shape_aliases: usize,
    ...
    pub(super) call_outcomes: HashMap<TextRange, TypeInferenceOutcome>,
    ...
    pub(super) deferred_calls: HashSet<TextRange>,
    pub(super) local_reads: Vec<(TextRange, RubyType)>,
    pub(super) unknown_reasons: HashMap<TextRange, UnknownReason>,
}
...
impl FactCollector {
    ...
    pub(super) fn recorded_call_expression_outcome(
        &self,
        range: TextRange,
    ...
    pub(super) fn record_immediate_call_outcome(
        &mut self,
        range: TextRange,
    ...
    pub(super) fn infer_type_from_value_with_locals(
        &self,
        value_node: &Node,
    ...
    pub(super) fn infer_collection_type_from_value(
        &self,
        value_node: &Node<'_>,
        local_types: &HashMap<String, RubyType>,
    ...
    pub(super) fn infer_call_type_outcome_with_locals(
        &self,
    ...
    pub(super) fn infer_if_expression_type(
        &self,
        if_node: &IfNode<'_>,
        local_types: &HashMap<String, RubyType>,
    ) -> RubyType {
    ...
    pub(super) fn infer_unless_expression_type(
        &self,
    ...
    pub(super) fn infer_case_expression_type(
        &self,
    ...
    pub(super) fn infer_begin_expression_type(
        &self,
    ...
    pub(super) fn infer_rescue_modifier_expression_type(
        &self,
    ...
    pub(super) fn record_call_expression_type(
        &mut self,
        node: &CallNode<'_>,
    ...
    pub(super) fn suppress_deferred_call_outcome(&mut self, range: TextRange, proof_kind: &str) {
...
pub(super) fn join_non_diverging_types(branches: &[(RubyType, bool)]) -> RubyType {
