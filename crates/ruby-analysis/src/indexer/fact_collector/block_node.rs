...
impl FactCollector {
    pub(super) fn process_block_node_entry(&mut self, node: &BlockNode) {
    ...
    pub(super) fn process_block_node_exit(&mut self, _node: &BlockNode) {
...
impl FactCollector {
    ...
    pub(super) fn static_dynamic_definition_block_context(
        &self,
        node: &CallNode,
    ) -> Option<(
        Vec<RubyConstant>,
    ...
    pub(super) fn concern_class_methods_block_namespace(
        &mut self,
        node: &CallNode,
    ...
    pub(super) fn resolve_static_eval_namespace(
        &self,
        parts: &[RubyConstant],
        absolute: bool,
    ) -> Option<Vec<RubyConstant>> {
