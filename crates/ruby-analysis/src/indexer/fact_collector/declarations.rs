...
impl FactCollector {
    ...
    pub(super) fn direct_push_resolved_edge_with_provenance(
        &mut self,
        source: FullyQualifiedName,
        target: FullyQualifiedName,
        kind: GraphEdgeKind,
    ...
    pub(super) fn direct_ancestry_path_exists(
        &self,
    ...
    pub(super) fn refresh_local_public_method_candidate(&mut self, fqn: &FullyQualifiedName) {
    ...
    pub(super) fn push_direct_expression_fact(&mut self, fact: TypeFact) {
    ...
    pub(super) fn direct_expression_fact(
        &self,
        range: TextRange,
...
pub(super) fn ancestry_edge_kind(kind: GraphEdgeKind) -> bool {
    match kind {
