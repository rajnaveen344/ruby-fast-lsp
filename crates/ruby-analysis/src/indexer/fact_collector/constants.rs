...
pub(super) struct ConstantEvidence {
    pub(super) equations: Vec<ConstantTypeEquation>,
    pub(super) callable_bodies: Vec<crate::core::ConstantCallableBodyFact>,
}

impl FactCollector {
    pub(super) fn constant_reference_type(&self, node: &Node) -> Option<FullyQualifiedName> {
    ...
    pub(super) fn const_get_reference_type(&self, call: &CallNode<'_>) -> Option<RubyType> {
    ...
    pub(super) fn direct_constant_value_type(
        &self,
    ...
    pub(super) fn const_get_target_parts(&self, call: &CallNode<'_>) -> Option<Vec<RubyConstant>> {
    ...
    pub(super) fn const_lookup_target_parts(
        &self,
        call: &CallNode<'_>,
    ...
    pub(super) fn const_lookup_base_parts(&self, receiver: &Node<'_>) -> Option<Vec<RubyConstant>> {
...
pub(super) fn const_get_arg_constant(arg: &Node<'_>) -> Option<RubyConstant> {
