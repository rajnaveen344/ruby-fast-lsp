...
impl AnalysisEngine {
                        ...
                        self.resolve_constant_reference(&parts, &current_namespace)
                    {
                        ...
                        unresolved_constants
                            ...
                            .push(DiagnosticFact::new(
                                candidate.range,
                                ruby_analysis_core::DiagnosticSeverity::Error,
                                "unresolved-constant",
                    ...
                    if let Some(fact) = fact {
                        ...
                        if diagnose_unresolved {
                            ...
                            unresolved_constants
                                ...
                                .push(DiagnosticFact::new(
                                    diagnostic_range,
                                    ruby_analysis_core::DiagnosticSeverity::Warning,
                                    "unresolved-method",
                                    message,
                                ));
                        }
    ...
    fn push_signature_diagnostics(
        &self,
        fact: &MethodFact,
        method: &ruby_analysis_core::RubyMethod,
    ...
    fn resolve_constant_reference(
        &self,
        parts: &[ruby_analysis_core::RubyConstant],
        current_namespace: &[ruby_analysis_core::RubyConstant],
...
mod tests {
    use ruby_analysis_core::{
        ...
        ReferenceCandidate, RubyConstant, RubyMethod, RubyType, SymbolFact, SymbolKind,
